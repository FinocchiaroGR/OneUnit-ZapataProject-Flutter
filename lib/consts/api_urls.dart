...
Uri carById = Uri.parse("$baseurl/cars/");
...
Uri carGeofence = Uri.parse("$baseurl/v1/gps/update-geofence/");
Uri activateGeofence = Uri.parse("$baseurl/v1/gps/activate/");
Uri deactivateGeofence = Uri.parse("$baseurl/v1/gps/deactivate/");
Uri carVelocity = Uri.parse("$baseurl/cars/update-velocity/");
